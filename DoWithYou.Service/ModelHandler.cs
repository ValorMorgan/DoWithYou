...
namespace DoWithYou.Service
{
        ...
        where T1 : IBaseEntity
    {
        ...
        public TModel Get(Func<IQueryable<T1>, T1> request1) =>
            _repository.Get(request1);
        ...
        where T2 : IBaseEntity
    {
        ...
        public TModel Get(Func<IQueryable<T1>, T1> request1, Func<IQueryable<T2>, T2> request2) =>
            _repository.Get(request1, request2);
        ...
        public IEnumerable<TModel> GetMany(Func<IQueryable<T1>, IEnumerable<T1>> request1, Func<IQueryable<T2>, IEnumerable<T2>> request2) =>
            _repository.GetMany(request1, request2)?.ToList() ?? new List<TModel>();
